...
function jfj_grant_scripts() {
    ...
    wp_enqueue_style('jfj-grant-style', get_stylesheet_uri(), array(), '1.0.0');
    wp_enqueue_script('jfj-grant-main', get_template_directory_uri() . '/js/main.js', array(), '1.0.0', true);
}
